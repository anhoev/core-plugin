    ...
    <v-layout row="" wrap="">
      ...
      <v-flex xs6="" v-if="imageUrl">
        <v-layout column="" justify-space-between="" align-end="" fill-height="">
          <v-flex shrink="">
            <v-btn flat="" icon="" color="grey" @click="openDialog">
              <v-icon>edit</v-icon>
            </v-btn>
          </v-flex>
    ...
    <v-dialog v-model="showDialog" v-if="imageUrl" max-width="600" persistent="" lazy="">
      <v-card>
        ...
        <v-card-text>
          <v-layout row="" wrap="">
            <v-flex xs5="">
              <v-text-field label="Width" v-model="dialogImageWidth" type="number" class="mt-0"></v-text-field>
            </v-flex>
            <v-spacer></v-spacer>
            <v-flex xs5="">
              <v-text-field label="Height" v-model="dialogImageHeight" type="number" class="mt-0"></v-text-field>
            </v-flex>
            <v-flex xs10="">
              <v-slider v-model="compressionSliderModel" label="Quality" min="1" max="100" step="1">
              </v-slider>
            </v-flex>
            <v-spacer></v-spacer>
            <v-flex shrink="" style="width: 60px;">
              <v-text-field v-model="compressionSliderModel" hide-details="" single-line="" type="number" class="mt-0"></v-text-field>
            </v-flex>
            <v-flex xs12="">
